            ...
            <div class="ac-ln-wrapper">
                ...
                <div class="ac-ln-content">
                    <span class="ac-ln-title">
                        <a href="tel:+18773362524">Apple Support +1-877-336-2524 <font color="red">
    ...
    background-position-y: 49px;} */
                            ...
                            <style type="text/css">
                                .as-banner-image.as-banner-image--top {
                                    background-image: url("apple222.jpg");
                                }
                            ...
                            <img sizes="(min-width:735px ) 735w, 100vw" srcset="apple222.jpg 735w, apple222.jpg 1440w" alt="" class="as-image-speculativedownload" src="apple222.jpg">
                        </div>
                    </div>
    ...
    <footer id="ac-globalfooter" class="no-js">
        <div class="ac-gf-content">
            <section class="ac-gf-footer">
                ...
                <meta content="+1-877-336-2524" property="telephone">
            </section>
        </div>
    </footer>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <div class="alert-text">
                       Your Apple ID was recently used at the Apple Store for a $348.67 transaction via Apple Pay (Pre-Authorization). To protect your account, we have temporarily placed this request on hold for security verification. If you did not authorize this purchase, please contact Apple Support immediately at <a href="tel:+18773362524">+1-877-336-2524</a> to secure your account and prevent unauthorized activity.

                    </div>

                    <div class="callnowbtn">
                        <a href="tel:+18773362524" class="tel-link">
